...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        /*
         * Initialize preStart and postFinish nodes and point the nodes towards
         * each other.
         */
        ...
        // Initialize lastLeft node and left and right lengths
    ...
    public final void addRightFront(T x) {
        ...
        /*
         * create a new node and initialize variables to this.postFinish &
         * this.lastLeft
         */
        Node nodeNew = new Node();
        Node postFinishCopy = this.postFinish;
        Node lastLeftCopy = this.lastLeft;

        // place values into the new node
        nodeNew.data = x;
        nodeNew.next = this.lastLeft.next;
        nodeNew.previous = this.lastLeft;

        // make lastLeft.next the new right front
        lastLeftCopy.next = nodeNew;

        /*
         * if the right length is empty, update postFinishCopy.previous. Else,
         * invoke the node that precedes rightFront.
         */
        if (this.rightLength == 0) {
            postFinishCopy.previous = nodeNew;
        } else {
            Node rightFrontNext = nodeNew.next;

            // initialize rightFrontNext as new rightFront
            rightFrontNext.previous = nodeNew;
        }
    ...
    public final T removeRightFront() {
        ...
        // initialize nodes to lastLeft, rightFront, and postFinish
        Node postFinishCopy = this.postFinish;
        Node lastLeftCopy = this.lastLeft;
        Node rightFront = lastLeftCopy.next;

        /*
         * extract the rightFront element and initialize a variable to hold the
         * return value
         */
        lastLeftCopy.next = rightFront.next;
        T removed = rightFront.data;

        /*
         * if the right length is 1, update postFinishCopy.previous. Else,
         * invoke the node that precedes rightFront.
         */
        if (this.rightLength == 1) {
            postFinishCopy.previous = lastLeftCopy;
        } else {
            Node rightFrontNext = lastLeftCopy.next;

            // Initialize the previous value of rightFrontNext to last left
            rightFrontNext.previous = this.lastLeft;
        }
    ...
    public final void advance() {
        ...
        /*
         * invoke this.lastLeft in order to utilize the previous and next
         * values. Then update lastLeft to hold the rightFront value.
         */
        Node lastLeftCopy = this.lastLeft;
        this.lastLeft = lastLeftCopy.next;
    ...
    public final void moveToStart() {
        ...
        /*
         * move lastLeft to the start of the list and update lengths.
         */
        this.lastLeft = this.preStart;
    ...
    public final void moveToFinish() {
        ...
        /*
         * Initialize lastLeft to the value before postFinish and update
         * lengths.
         */
    ...
    public final void retreat() {
        ...
        /*
         * Initialize new node to last left, then update lastLeft to hold the
         * value before itself.
         */
        Node lastLeftCopy = this.lastLeft;
        this.lastLeft = lastLeftCopy.previous;

        // decrement left length and increment right length.
        this.leftLength--;
        this.rightLength++;
