...
public abstract class ListTest {
    ...
    /**
     * A test case for retreat where the left side has one entry and the * right
     * side is not empty when method is called.
     */
    @Test
    public final void testRetreatLeftOneRightNonEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "purple", "green",
                "blue");
        List<String> list2 = this.createFromArgsRef(0, "purple", "green",
                "blue");
        /*
         * Call method under test
         */
    ...
    /**
     * A test case for retreat where the left side has one entry and the right
     * side is empty when method is called.
     */
    @Test
    public final void testRetreatLeftOneRightEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "purple");
        List<String> list2 = this.createFromArgsRef(0, "purple");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    /**
     * A test case for retreat where the left side is non empty and the right
     * side is empty when method is called.
     */
    @Test
    public final void testRetreatLeftNonEmptyRightEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "purple", "green",
                "blue");
        List<String> list2 = this.createFromArgsRef(2, "purple", "green",
                "blue");
        /*
         * Call method under test
         */
    ...
    /**
     * A test case for retreat where the left side is not empty and the right
     * side is not empty when method is called.
     */
    @Test
    public final void testRetreatLeftNonEmptyRightNonEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "purple", "green",
                "blue", "yellow");
        List<String> list2 = this.createFromArgsRef(1, "purple", "green",
                "blue", "yellow");
        /*
         * Call method under test
         */
