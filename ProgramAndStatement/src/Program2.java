...
public class Program2 extends ProgramSecondary {
    ...
    public final Map<String, Statement> newContext() {
        ...
        // create a new variable with the same type
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        // use a temporary variable to hold the transfer values
        Map<String, Statement> swapTemp = this.context.newInstance();

        // swap the values
        swapTemp.transferFrom(this.context);
        this.context.transferFrom(c);
        c.transferFrom(swapTemp);
    ...
    public final void swapBody(Statement b) {
        ...
        // use a temporary variable to hold the transfer values
        Statement swapTemp = b.newInstance();

        // swap the values
        swapTemp.transferFrom(this.body);
        this.body.transferFrom(b);
        b.transferFrom(swapTemp);
